...
public class Publisher {
    ...
    /**
     * Unsubscribe remote property listener. Listener will be unsubscribed from
     * given property. In case given property is the null-string, the listener
     * will be unsubscribed from all properties.
     *
    ...
    private void unsubscribeListener(IPropertyListener listener, String property) {
        if (property != null) {
            ...
            /**
             * REMARK BY NICO KUIJPERS. Set<String> keyset =
             * propertyListeners.keySet(); may cause a
             * java.util.ConcurrentModificationException when the key set
             * changes. Therefore, the key set is copied to an ArrayList.
             */
    ...
    public void unregisterProperty(String property) {
        ...
        if (property != null) {
            ...
            /**
             * REMARK BY NICO KUIJPERS. Set<String> keyset =
             * propertyListeners.keySet(); causes
             * java.util.ConcurrentModificationException as the key set changes
             * while keys are being removed. Therefore, the key set is copied to
             * an ArrayList. Corresponding test method:
             * testUnregisterPropertyAllProperties().
             */
            List<String> keyset = new ArrayList<>(propertyListeners.keySet());
            for (String key : keyset) {
                if (key != null) {
