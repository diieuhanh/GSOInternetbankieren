...
public interface IRemotePropertyListener extends IPropertyListener, Remote {
    ...
    /**
     * Inform listener about change of a property in the domain. On the basis of
     * the data provided by the instance of PropertyChangeEvent the observer is
     * synchronized with respect to the remote domain.
     *
     *
