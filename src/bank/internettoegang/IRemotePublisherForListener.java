...
/**
 * IRemotePublisherForListener. Interface to remote publisher in order to
 * subscribe and unsubscribe listeners to properties. In case a property changes
 * in the domain, all listeners subscribed to that property will be informed
 * through a (remote) method invocation of propertyChange(). Listeners
 * subscribed to the null-String are by definition subscribed to all properties.
 *
...
public interface IRemotePublisherForListener extends Remote {
    ...
    /**
     * Unsubscribe remote property listener. Remote listener will be
